  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-20">
        ...
        <p className='text-white'>Uprise Media are an end-to-end interactive Digital Consulting Agency with a<br /> blend of smart technologies and marketing ideas. </p>
