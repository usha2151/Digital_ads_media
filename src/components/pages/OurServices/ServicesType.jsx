      ...
      <div className='container mx-auto'>
       ...
       <div className='grid grid-cols-1 lg:grid-cols-2 lg:py-8 lg:pb-8 pb-16 pt-10'>
        ...
        <div className='mx-4 lg:mx-0'>
          ...
          <button className='hover:bg-blue hover:text-white border-2 border-black p-6 mt-5 text-black lg:mb-6'>Contact Us</button>
        </div>
       </div>
       {/* third row end */}
       ...
       <div className='grid grid-cols-1 lg:grid-cols-2 py-8 pb-8'>
        ...
        <div className='mx-4 lg:mx-0'>
          ...
          <div className='w-3/4 h-0.5 bg-gray mt-4'></div>
          <button className='hover:bg-blue hover:text-white border-2 border-black p-6 mt-5 lg:mb-6'>Contact Us</button>
        </div>
       </div>
